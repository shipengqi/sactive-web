...
class RouterWrapper {
  constructor(descriptor) {
    ...
    descriptor.paramValidations = this.validationsToWrap(descriptor.paramValidations);
    descriptor.queryValidations = this.validationsToWrap(descriptor.queryValidations);
    descriptor.dataValidations = this.validationsToWrap(descriptor.dataValidations);
    descriptor.paramNormalizations = this.normalizationsToWrap(descriptor.paramNormalizations);
    descriptor.queryNormalizations = this.normalizationsToWrap(descriptor.queryNormalizations);
    descriptor.dataNormalizations = this.normalizationsToWrap(descriptor.dataNormalizations);
    descriptor.dependencies.push('$$responseTransform');
